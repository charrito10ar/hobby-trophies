...
public class TrophyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TrophyAdapter(Context context, String gameId) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                View itemViewTrophy = inflater.inflate(R.layout.list_item_trophy, parent, false);
        ...
        public void setTrophyType(String trophyType) {
            switch (trophyType.toLowerCase()){
                ...
                case Constants.TROPHY_TYPE_PLATINUM:
                    ...
                    break;
                default:
                    this.imageTrophyType.setVisibility(View.INVISIBLE);
            }
